    ...
    return(
      <section className="player-bar fixed">
        <div className="mdl-grid">
          <section id="time-control" className="mdl-cell--3-col mdl-cell--2-col-tablet  mdl-cell--4-col-phone">
          ...
          <section id="buttons"  className="mdl-cell--6-col mdl-cell--4-col-tablet  mdl-cell--4-col-phone">
          ...
          <section id="volume-control"  className="mdl-cell--3-col mdl-cell--2-col-tablet  mdl-cell--4-col-phone">
              <input className="mdl-slider mdl-js-slider" type="range"
